---
tags: [active, perennial, herb]
location: backyard
planted: 2021-11-01
botanical_name: Lavandula dentata
family: Lamiaceae
genus: Lavandula
---
...
=== "2026-06-10"
    ...
    ![french-lavender][1]{ width="400" loading=lazy }

!!! example ""

    **:material-leaf: Type:** Evergreen Shrub

    **:material-tag-text-outline: Botanical Name:** *Lavandula dentata*

    **:material-sitemap-outline: Family:** Lamiaceae

    **:material-folder-outline: Genus:** Lavandula
    ...
    **:material-texture: Soil:** Well-drained, sandy, or gravelly soil.
...
* **Trefle Database Info:**
    * **Scientific Name:** *Lavandula dentata* (Lamiaceae Family)

[1]: <../assets/images/french-lavender-2026-06-10.webp>
