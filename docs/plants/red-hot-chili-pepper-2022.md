...
=== "2022-02-15"
    ...
    ![red-hot-chili-pepper-2022][1]{ width="400" loading=lazy }


!!! example ""

    **:material-leaf: Type:** Herbaceous Subshrub
    ...
    **:material-dna: Variety:** Red Hot Chili Pepper

    **:material-seed: Origin:** Seed (Indoor Start)

    **:material-map-marker-outline: Location:** Click & Grow

    **:material-calendar-check-outline: Date Planted:** 2022-02-15 (Late Fall / Winter)

    **:material-list-status: Status:** Harvested / Cleared
    **:material-calendar-remove-outline: Date Removed:** 2023-02-15
    **:material-chat-alert-outline: Outcome:** Harvested from Click & Grow.

    **:material-weather-sunny: Sunlight:** Full sun

    **:material-texture: Soil:** Moist, well-draining loam

## :clipboard: Cultivation Status

## :memo: Log & Observations

* **2022-02-15:** Initial logging. Planted in Click & Grow.
...
[1]: <../assets/images/red-hot-chili-pepper-2022.webp>